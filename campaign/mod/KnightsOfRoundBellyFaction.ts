namespace AdmiralNelsonKnightsOfTheRoundBelly {
    ...
    export class Faction {
        ...
        /**
         * Grants the specified ancillary to this faction. The ancillary goes into that faction's ancillary pool, from where it may be equipped by a character.
         ...
         */
        public AddAnciliary(anciliaryKey: string, dontShowNotification: boolean = true) {
            cm.add_ancillary_to_faction(this.GetFactionInterface(), anciliaryKey, dontShowNotification)
        }
